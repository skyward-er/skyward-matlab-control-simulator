...
MS580301BA01.noiseVariance=20; % guess in mbar
...
% initial testSensorPosition
testSensorPosition=Sensor3D();
testSensorPosition.maxMeasurementRange=3100;
testSensorPosition.minMeasurementRange=0;
testSensorPosition.resolution=10;
testSensorPosition.noiseVariance=100;
testSensorPosition.walkDiffusionCoef=100;
testSensorPosition.dt=0.01;

% initial testSensorVelocity
testSensorVelocity=Sensor3D();
testSensorVelocity.maxMeasurementRange=300;
testSensorVelocity.minMeasurementRange=0;
testSensorVelocity.resolution=5;
testSensorVelocity.noiseVariance=30;
testSensorVelocity.walkDiffusionCoef=30;
testSensorVelocity.dt=0.01;
