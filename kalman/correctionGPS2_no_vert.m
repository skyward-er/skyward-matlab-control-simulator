function [x,P,y_res] = correctionGPS2_no_vert(x_pred,P_pred,x_sam,y_sam,z_sam,vGPS,sigma_GPS,sats,fix)
...
%---------------------------------------------------------------------------
threshold      =   10e-3;
H              =   sparse(4,6);                 %Pre-allocation of gradient 
H(1,1)=1;                                                 %of the output function  
H(2,2)=1;
H(3,4)=1;
H(4,5)=1;
...
z              =   [x_pred(1:2)';x_pred(4:5)'];

e              =   [x_sam;y_sam;vGPS(1:2)'] - z;
